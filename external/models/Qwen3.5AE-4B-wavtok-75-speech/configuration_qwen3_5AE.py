...
class AudioConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        wavtok_ckpt_path="/mnt/tmp/hf_cache/wavtokenizer/WavTokenizer-large-speech-75token/wavtokenizer_large_speech_320_v2.ckpt",
        wavtok_sample_rate=24000,
        wavtok_fps=75,                   # encoder output frame rate
        wavtok_hop_length=320,           # samples per output frame (24000 / 75)
        wavtok_dimension=512,            # z_e dimension
        wavtok_n_filters=32,             # SEANetEncoder n_filters
        wavtok_ratios=[8, 5, 4, 2],      # downsampling ratios (product=320)
