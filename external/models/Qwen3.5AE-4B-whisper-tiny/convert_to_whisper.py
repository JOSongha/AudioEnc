...
Usage:
    python convert_to_whisper.py \
        ...
        --whisper-model-id openai/whisper-small.en \
        --dtype bfloat16
"""
...
def main():
    ...
    parser.add_argument("--whisper-model-id", default="openai/whisper-small.en", help="HF whisper model ID (e.g. openai/whisper-tiny.en)")
    ...
    whisper_cfg = WhisperConfig.from_pretrained(args.whisper_model_id)
    audio_cfg = cfg_mod.AudioConfig(
        whisper_model_id=args.whisper_model_id,
        audio_hidden_size=whisper_cfg.d_model,
