...
# ── Training ──────────────────────────────────────────────────────────────────
# MODEL_PATH=/mnt/tmp/results/Qwen3.5AE-ASR-Stage1/checkpoint-31000
# OMNI_MANIFEST=/mnt/ddn/users/sehyun/AudioEncoder/audiollm-trainer/external/datasets/qwen3_5_dacvae_asr_shuffled_128

FORCE_TORCHRUN=1 NNODES=$NSML_WORLD_SIZE NODE_RANK=$NSML_RANK MASTER_ADDR=$NSML_HOST_RANK0 MASTER_PORT=21267 \
    llamafactory-cli train /mnt/ddn/users/sehyun/AudioEncoder/audiollm-trainer/external/configs/stage2.yaml