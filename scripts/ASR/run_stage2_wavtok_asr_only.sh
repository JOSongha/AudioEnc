#!/bin/bash
# Stage2 training: WavTok-40-unify ASR-only (LoRA + projector, 8-GPU DeepSpeed Z2).
...
FORCE_TORCHRUN=1 NNODES=$NSML_WORLD_SIZE NODE_RANK=$NSML_RANK MASTER_ADDR=$NSML_HOST_RANK0 MASTER_PORT=21267 \
    ...
    /mnt/ddn/users/sehyun/AudioEncoder/audiollm-trainer/configs/qwen3_5ae-asr/stage2_wavtok_40_unify_asr_only.yaml
