#!/bin/bash
# Stage1 v4: WavTok 40-token multi-task (ASR 65% / env_sound 25% / emotion 10%).
# Same interleave design as colleague's DAC-VAE v4 that achieved WER 6.
...
FORCE_TORCHRUN=1 NNODES=$NSML_WORLD_SIZE NODE_RANK=$NSML_RANK MASTER_ADDR=$NSML_HOST_RANK0 MASTER_PORT=21267 \
    ...
    /mnt/ddn/users/sehyun/AudioEncoder/audiollm-trainer/configs/ASR/stage1_wavtok_40_unify_v4.yaml
