#!/bin/bash
# Phase 1b-A: WavTok Stage 1 multi-task curriculum (resume from ASR ckpt-100000).
...
FORCE_TORCHRUN=1 NNODES=$NSML_WORLD_SIZE NODE_RANK=$NSML_RANK MASTER_ADDR=$NSML_HOST_RANK0 MASTER_PORT=21267 \
    ...
    /mnt/ddn/users/sehyun/AudioEncoder/audiollm-trainer/configs/ASR/stage1b_wavtok_40_unify_resume_multitask.yaml
