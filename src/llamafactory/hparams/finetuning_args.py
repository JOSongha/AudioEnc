...
class FinetuningArguments(
    ...
    token_weights: Optional[List[Dict[str, Any]]] = field(
        default=None,
        metadata={
            "help": "List of dictionaries containing token and weight pairs for weighted training. Each dict should have 'token' and 'weight' keys."
        },
    )    
