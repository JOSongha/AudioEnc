...
export RUN_NAME=voice_engine_v5_vm_v5_lora
...
FORCE_TORCHRUN=1 NNODES=1 NODE_RANK=0 MASTER_ADDR=10.169.39.114 MASTER_PORT=11437 llamafactory-cli train examples/train_lora/speechx_lora_v5_voice_engine.yaml