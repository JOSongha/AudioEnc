...
export RUN_NAME=voice_engine_v5_2_vm_v5_2_lora
...
FORCE_TORCHRUN=1 NNODES=1 NODE_RANK=0 MASTER_ADDR=10.169.40.18 MASTER_PORT=11686 llamafactory-cli train examples/train_lora/speechx_lora_v5_2_voice_engine_v2.yaml