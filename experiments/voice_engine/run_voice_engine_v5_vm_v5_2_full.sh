...
export RUN_NAME=voice_engine_v5_vm_v5_2_full
...
FORCE_TORCHRUN=1 NNODES=1 NODE_RANK=0 MASTER_ADDR=10.169.39.24 MASTER_PORT=11551 llamafactory-cli train examples/train_full/speechx_full_v5_2_voice_engine_sft.yaml