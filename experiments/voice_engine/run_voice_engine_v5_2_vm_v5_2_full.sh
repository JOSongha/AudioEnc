...
export RUN_NAME=voice_engine_v5_2_vm_v5_2_full
...
# FORCE_TORCHRUN=1 NNODES=1 NODE_RANK=0 MASTER_ADDR=10.169.40.18 MASTER_PORT=11453 llamafactory-cli train examples/train_full/speechx_full_v5_2_voice_engine_sft_v2.yaml
