#!/usr/bin/env bash
# Wrapper: set up nvidia/glibc env then run extract.py with conda audiollm.
# Usage: bash run_extract.sh --family whisper_tiny [--speakers bdl,slt] [--max_utt_per_speaker 2]
